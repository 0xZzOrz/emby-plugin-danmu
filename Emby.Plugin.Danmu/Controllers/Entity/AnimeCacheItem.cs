namespace Emby.Plugin.Danmu.Controllers.Entity
{
    ...
    public class AnimeCacheItem
    {
        ...
        [JsonConstructor]
        public AnimeCacheItem(string scraperProviderId, string id, Emby.Plugin.Danmu.Scrapers.Dandan.Entity.Anime? animeData)
        {
        ...
        /// </summary>
        public Emby.Plugin.Danmu.Scrapers.Dandan.Entity.Anime? AnimeData { get; set; }
    }
}